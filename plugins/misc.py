...
from . import async_searcher, get_random_user_data, get_string, re, GOKU_USERBOT_cmd


@GOKU_USERBOT_cmd(pattern="eod$")
async def diela(e):
...
@GOKU_USERBOT_cmd(pattern="gadget( (.*)|$)")
async def mobs(e):
...
@GOKU_USERBOT_cmd(pattern="randomuser")
