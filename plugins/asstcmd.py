...
from GOKU_USER.dB.asstcmd_db import add_cmd, cmd_reply, list_cmds, rem_cmd
...
from . import asst, get_string, mediainfo, udB, GOKU_USERBOT_cmd


@GOKU_USERBOT_cmd(pattern="addcmd( (.*)|$)")
async def ac(e):
