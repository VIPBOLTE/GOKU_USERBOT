...
from GOKU_USER.fns.tools import get_chatbot_reply

from . import LOGS, eod, get_string, inline_mention, udB, GOKU_USERBOT_cmd


@GOKU_USERBOT_cmd(pattern="repai")
